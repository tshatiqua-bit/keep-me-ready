...
export default function LessonCard({
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-8 lg:p-10">
      ...
      <div className="mb-5 sm:mb-7">
        <span className="inline-block text-xs font-semibold uppercase tracking-wider text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-md mb-3 sm:mb-4">
          Today&apos;s Topic
        </span>
      ...
      {/* Lesson */}
      <p className="text-base text-slate-600 leading-7 sm:leading-8 mb-5 sm:mb-8">
        {topic.lesson}
      </p>

      {/* Why it matters */}
      <div className="border-l-4 border-green-400 bg-green-50 rounded-r-xl px-4 py-4 sm:px-5 sm:py-5 mb-4 sm:mb-5">
      ...
      {/* Common confusion */}
      <div className="border-l-4 border-amber-400 bg-amber-50 rounded-r-xl px-4 py-4 sm:px-5 sm:py-5 mb-7 sm:mb-10">
